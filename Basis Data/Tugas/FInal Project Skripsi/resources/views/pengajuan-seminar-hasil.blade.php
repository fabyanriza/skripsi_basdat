    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="w-3/4 p-10 flex h-full">
            ...
            <div class="bg-purple-400 p-6 mt-8 rounded-lg">
                <h2 class="text-lg font-bold mb-4">Pengajuan Seminar Hasil</h2>
                ...
                <div class="mb-4">
                    <label class="block mb-2">Upload Kartu Persetujuan Seminar Hasil</label>
                    <input type="file" class="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer focus:outline-none">
                </div>
                ...
                <div class="mt-6">
                    <h2 class="text-lg font-bold mb-4">Status Pengajuan Seminar Hasil</h2>
