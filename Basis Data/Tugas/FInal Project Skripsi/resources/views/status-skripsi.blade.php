...
<body class="bg-purple-200">
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="w-3/4 p-10 flex h-full">
            ...
            <div class="w-full overflow-y-auto">
                <h1 class="text-3xl font-bold mb-6">Status Skripsi</h1>
    
                <!-- Informasi Skripsi -->
    <div class="bg-purple-400 p-6 rounded-lg">
        <h2 class="text-lg font-bold mb-4">Informasi Skripsi</h2>
    ...
    <!-- Catatan Dosen -->
    <div class="bg-purple-400 p-6 mt-4 rounded-lg h-[370px]">
        <h2 class="text-lg font-bold mb-4">Catatan Dosen</h2>
        <div class="bg-white h-[260px] rounded-lg"></div>
    </div>
                    </div>
                </div>
    
            <!-- Sidebar Right (Calendar and Notifications) -->
            <div class="flex flex-col w-1/3 space-y-6 mt-10 mr-5">
                <!-- Calendar -->
